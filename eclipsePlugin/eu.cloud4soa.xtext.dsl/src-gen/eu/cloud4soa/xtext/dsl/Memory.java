 ...
 * <ul>
 *   <li>{@link eu.cloud4soa.xtext.dsl.Memory#getMemory <em>Memory</em>}</li>
 * </ul>
 * </p>
 *
 * @see eu.cloud4soa.xtext.dsl.DslPackage#getMemory()
 * @model
 * @generated
 */
public interface Memory extends EObject
{
   ...
   * @see #setMemory(int)
   * @see eu.cloud4soa.xtext.dsl.DslPackage#getMemory_Memory()
   * @model
   * @generated
   */
  int getMemory();
  ...
  /**
   * Sets the value of the '{@link eu.cloud4soa.xtext.dsl.Memory#getMemory <em>Memory</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
