 ...
 * <ul>
 *   <li>{@link eu.cloud4soa.xtext.dsl.impl.LatencyImpl#getLatency <em>Latency</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class LatencyImpl extends MinimalEObjectImpl.Container implements Latency
{
  ...
  {
    return DslPackage.Literals.LATENCY;
  }
  ...
  public void setLatency(int newLatency)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, DslPackage.LATENCY__LATENCY, oldLatency, latency));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case DslPackage.LATENCY__LATENCY:
        return getLatency();
    }
