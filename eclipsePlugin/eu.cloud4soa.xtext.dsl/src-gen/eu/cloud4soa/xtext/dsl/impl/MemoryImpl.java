 ...
 * <ul>
 *   <li>{@link eu.cloud4soa.xtext.dsl.impl.MemoryImpl#getMemory <em>Memory</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class MemoryImpl extends MinimalEObjectImpl.Container implements Memory
{
  ...
  {
    return DslPackage.Literals.MEMORY;
  }
  ...
  public void setMemory(int newMemory)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, DslPackage.MEMORY__MEMORY, oldMemory, memory));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case DslPackage.MEMORY__MEMORY:
        return getMemory();
    }
