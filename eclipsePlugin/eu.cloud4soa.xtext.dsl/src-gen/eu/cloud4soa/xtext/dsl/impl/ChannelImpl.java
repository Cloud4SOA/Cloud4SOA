 ...
 * <ul>
 *   <li>{@link eu.cloud4soa.xtext.dsl.impl.ChannelImpl#getOperation <em>Operation</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ChannelImpl extends MinimalEObjectImpl.Container implements Channel
{
  ...
  {
    return DslPackage.Literals.CHANNEL;
  }
  ...
  public EList<Operation> getOperation()
  {
    if (operation == null)
    {
      operation = new EObjectContainmentEList<Operation>(Operation.class, this, DslPackage.CHANNEL__OPERATION);
    }
    return operation;
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case DslPackage.CHANNEL__OPERATION:
