 ...
 * <ul>
 *   <li>{@link eu.cloud4soa.xtext.dsl.impl.ChannelsImpl#getChannel <em>Channel</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ChannelsImpl extends MinimalEObjectImpl.Container implements Channels
{
  ...
  {
    return DslPackage.Literals.CHANNELS;
  }
  ...
  public EList<Channel> getChannel()
  {
    if (channel == null)
    {
      channel = new EObjectContainmentEList<Channel>(Channel.class, this, DslPackage.CHANNELS__CHANNEL);
    }
    return channel;
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case DslPackage.CHANNELS__CHANNEL:
