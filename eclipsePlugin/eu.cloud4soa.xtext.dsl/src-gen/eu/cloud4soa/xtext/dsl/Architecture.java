 ...
 * <ul>
 *   <li>{@link eu.cloud4soa.xtext.dsl.Architecture#getArchitecture <em>Architecture</em>}</li>
 * </ul>
 * </p>
 *
 * @see eu.cloud4soa.xtext.dsl.DslPackage#getArchitecture()
 * @model
 * @generated
 */
public interface Architecture extends EObject
{
   ...
   * @see eu.cloud4soa.xtext.dsl.DslPackage#getArchitecture_Architecture()
   * @model
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link eu.cloud4soa.xtext.dsl.Architecture#getArchitecture <em>Architecture</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
