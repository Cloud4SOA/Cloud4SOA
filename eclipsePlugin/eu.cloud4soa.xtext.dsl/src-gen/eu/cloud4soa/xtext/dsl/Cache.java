 ...
 * <ul>
 *   <li>{@link eu.cloud4soa.xtext.dsl.Cache#getCache <em>Cache</em>}</li>
 * </ul>
 * </p>
 *
 * @see eu.cloud4soa.xtext.dsl.DslPackage#getCache()
 * @model
 * @generated
 */
public interface Cache extends EObject
{
   ...
   * @see #setCache(int)
   * @see eu.cloud4soa.xtext.dsl.DslPackage#getCache_Cache()
   * @model
   * @generated
   */
  int getCache();
  ...
  /**
   * Sets the value of the '{@link eu.cloud4soa.xtext.dsl.Cache#getCache <em>Cache</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
