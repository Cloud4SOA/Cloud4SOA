 ...
 * <ul>
 *   <li>{@link eu.cloud4soa.xtext.dsl.Bandwidth#getBandwidth <em>Bandwidth</em>}</li>
 * </ul>
 * </p>
 *
 * @see eu.cloud4soa.xtext.dsl.DslPackage#getBandwidth()
 * @model
 * @generated
 */
public interface Bandwidth extends EObject
{
   ...
   * @see eu.cloud4soa.xtext.dsl.DslPackage#getBandwidth_Bandwidth()
   * @model
   * @generated
   */
  int getBandwidth();
  ...
  /**
   * Sets the value of the '{@link eu.cloud4soa.xtext.dsl.Bandwidth#getBandwidth <em>Bandwidth</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
