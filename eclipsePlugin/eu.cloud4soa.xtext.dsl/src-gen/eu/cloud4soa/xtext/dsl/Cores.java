 ...
 * <ul>
 *   <li>{@link eu.cloud4soa.xtext.dsl.Cores#getCores <em>Cores</em>}</li>
 * </ul>
 * </p>
 *
 * @see eu.cloud4soa.xtext.dsl.DslPackage#getCores()
 * @model
 * @generated
 */
public interface Cores extends EObject
{
   ...
   * @see #setCores(int)
   * @see eu.cloud4soa.xtext.dsl.DslPackage#getCores_Cores()
   * @model
   * @generated
   */
  int getCores();
  ...
  /**
   * Sets the value of the '{@link eu.cloud4soa.xtext.dsl.Cores#getCores <em>Cores</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
