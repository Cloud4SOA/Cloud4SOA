 ...
 * @author vins
 */
public class PaaSUserDescriptionGenerator {
    
    final Logger logger = LoggerFactory.getLogger(PaaSUserDescriptionGenerator.class);
    
//    private static ApplicationDescriptionGenerator instance = null;
    
    private static String templateName = "paasuser.vm";
    private TemplateGenerator templateGenerator = null;

    private List<String> allowedValues = new ArrayList<String>();


    public PaaSUserDescriptionGenerator() {
        allowedValues.add("paasUserUriId");
        allowedValues.add("paasProviderUriId");
        allowedValues.add("homepageUriId");
