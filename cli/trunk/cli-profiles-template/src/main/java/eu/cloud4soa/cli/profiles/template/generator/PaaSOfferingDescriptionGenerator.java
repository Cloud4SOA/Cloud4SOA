 ...
 * @author vins
 */
public class PaaSOfferingDescriptionGenerator {
    
    final Logger logger = LoggerFactory.getLogger(PaaSOfferingDescriptionGenerator.class);
    
//    private static ApplicationDescriptionGenerator instance = null;
    
    private static String templateName = "paasoffering.vm";
    private TemplateGenerator templateGenerator = null;

    private List<String> allowedValues = new ArrayList<String>();


    public PaaSOfferingDescriptionGenerator() {
        allowedValues.add("paasOfferingUriId");
