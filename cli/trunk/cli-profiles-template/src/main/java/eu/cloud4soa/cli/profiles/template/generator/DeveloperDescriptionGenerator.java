 ...
 * @author vins
 */
public class DeveloperDescriptionGenerator {
    
    final Logger logger = LoggerFactory.getLogger(DeveloperDescriptionGenerator.class);
    
//    private static ApplicationDescriptionGenerator instance = null;
    
    private static String templateName = "developer.vm";
    private TemplateGenerator templateGenerator = null;

    private List<String> allowedValues = new ArrayList<String>();


    public DeveloperDescriptionGenerator() {
        allowedValues.add("developerUriId");
