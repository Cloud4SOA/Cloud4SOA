...
public class DeleteSSHKeyRequest extends Request<DeleteSSHKeyResponse> implements Serializable{
	private static final long serialVersionUID = -6258964837210537511L;
