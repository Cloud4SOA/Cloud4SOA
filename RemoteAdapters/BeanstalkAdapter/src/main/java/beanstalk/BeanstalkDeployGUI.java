...
public class BeanstalkDeployGUI {
  ...
  //  public static void main(String[] args) throws Exception {
   ...
   // }
    ...
    //version for cli
    public BeanstalkDeployGUI(String[] args) throws Exception {
    ...
    public BeanstalkDeployGUI(Boolean getJframe){
        /*if(getJframe==true){
        frame = new JFrame("Amazon S3 File Upload");
        button = new JButton("Choose File...");
        button.addActionListener(new ButtonListener());
...
////////////////////////////////////starting CreateApplicationVersion
            if (uploaded_to_s3 == true) {
                ...
                try {
                    ...
                    Logger.getLogger(BeanstalkDeployGUI.class.getName()).log(Level.SEVERE, null, ex);
