 ...
 */
public class BeansDescribeEnvironments {

    private static final String ACTION_NAME = "DescribeEnvironments";
  //  private static final String ACTION_NAME = "CheckDNSAvailability";
   ...
   public BeansDescribeEnvironments(){

    }
    public BeansDescribeEnvironments(String accessKeyId, String secretAccessKey) {
...
//    public static void main(String[] args) throws Exception {
    ...
    */
    ...
    public String getEnvironments(String accessKeyId, String secretAccessKey, String environment,
...
//        this.description = description;
        ...
        try {
            ...
            // String war = "cloud4soa";
            BeansDescribeEnvironments updater = new BeansDescribeEnvironments(accessKeyId, secretAccessKey);
            String query = updater.buildQuery();
            String toSign = "GET\n" + service_host + "\n/\n" + query;
            System.out.println("String to sign:\n" + toSign + "\n");
            ...
            try {
                ...
                Logger.getLogger(BeansDescribeEnvironments.class.getName()).log(Level.SEVERE, null, ex);
            }
