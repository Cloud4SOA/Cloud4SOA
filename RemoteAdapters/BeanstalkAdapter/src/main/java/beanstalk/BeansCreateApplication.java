 ...
 */
public class BeansCreateApplication {

    private static final String ACTION_NAME = "CreateApplication";
   ...
   // private static final String RESPONSE_GROUP_NAME = "Rank,ContactInfo,LinksInCount";
    ...
    public BeansCreateApplication(String accessKeyId, String secretAccessKey, String application, String description ) {
...
/*
    ...
    */
    ...
    public void creatapp(String accessKeyId, String secretAccessKey,
            String application, String description ) throws Exception {
        /*if (args.length < 3) {
        System.err.println("Usage: UrlInfo ACCESS_KEY_ID " +
        "SECRET_ACCESS_KEY site");
        System.exit(-1);
        ...
        BeansCreateApplication newapp = new BeansCreateApplication( accessKeyId, secretAccessKey,application,description);

        String query = newapp.buildQuery();

        String toSign = "GET\n" + SERVICE_HOST + "\n/\n" + query;

        System.out.println("String to sign:\n" + toSign + "\n");

        String signature = newapp.generateSignature(toSign);
