 ...
 */
public class BeansCreateEnvironment {
  ...
  //  private static final String ACTION_NAME = "CheckDNSAvailability";
   ...
   public BeansCreateEnvironment(){

    }
    public BeansCreateEnvironment(String accessKeyId, String secretAccessKey, String environment,String application, String appversion, String description) {
...
//    public static void main(String[] args) throws Exception {
    ...
    */
    ...
    public void createupdateenvironment(String accessKeyId, String secretAccessKey, String environment,
        ...
        try {
            ...
            // String war = "cloud4soa";
            BeansCreateEnvironment updater = new BeansCreateEnvironment(accessKeyId, secretAccessKey, environment, application, appversion, description);
            String query = updater.buildQuery();
            String toSign = "GET\n" + service_host + "\n/\n" + query;
            System.out.println("String to sign:\n" + toSign + "\n");
            ...
            try {
                ...
                Logger.getLogger(BeansCreateEnvironment.class.getName()).log(Level.SEVERE, null, ex);
            }
