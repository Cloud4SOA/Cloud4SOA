...
//import eu.cloud4soa.api.util.exception.adapter.BeanstalkAdapterException;
...
////////////////////////////////////starting CreateEnvironment if environment not found
  ...
  //  }//end of CLASS ButtonListener
	...
	public void upload_file_to_s3(String bucketName, String keyName,String uploadFileName, String AWSKeyId, String AWSSecretKey) throws BeanstalkAdapterException {
        ...
        try {
            ...
            throw new BeanstalkAdapterException(ase.getMessage());
            ...
            throw new BeanstalkAdapterException(ace.getMessage());
