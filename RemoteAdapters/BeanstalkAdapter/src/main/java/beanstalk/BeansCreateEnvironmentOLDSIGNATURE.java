 ...
 */
public class BeansCreateEnvironmentOLDSIGNATURE {

    private static final String ACTION_NAME = "CreateEnvironment";
  //  private static final String ACTION_NAME = "CheckDNSAvailability";
    ...
    public BeansCreateEnvironmentOLDSIGNATURE(String accessKeyId, String secretAccessKey, String environment,String application, String appversion, String description) {
    ...
    BeansCreateEnvironmentOLDSIGNATURE(){
    ...
    protected String buildQuery()
        ...
        queryParams.put("SolutionStackName", "32bitfewfwefwe07");
...
//    public static void main(String[] args) throws Exception {
    ...
    */
    ...
    public void createupdateenvironment(String accessKeyId, String secretAccessKey, String enviroment,
            String application, String appversion, String description ) throws InvalidParameterValueException {
        try {
            /*if (args.length < 3) {
            System.err.println("Usage: UrlInfo ACCESS_KEY_ID " +
            "SECRET_ACCESS_KEY site");
            ...
            // String war = "cloud4soa";
            BeansCreateEnvironmentOLDSIGNATURE updater = new BeansCreateEnvironmentOLDSIGNATURE(accessKeyId, secretAccessKey, enviroment, application, appversion, description);
            String query = updater.buildQuery();
            String toSign = "GET\n" + service_host + "\n/\n" + query;
            System.out.println("String to sign:\n" + toSign + "\n");
            ...
            try {
                ...
                Logger.getLogger(BeansCreateEnvironmentOLDSIGNATURE.class.getName()).log(Level.SEVERE, null, ex);
            }
