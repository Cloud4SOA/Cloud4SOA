 ...
 */
public class BeansUpdateEnvironment {

    private static final String ACTION_NAME = "UpdateEnvironment";
    ...
    public BeansUpdateEnvironment(String accessKeyId, String secretAccessKey, String environment,String application, String appversion, String description) {
...
//    public static void main(String[] args) throws Exception {
    ...
    */
    ...
    public void updateenvironment(String accessKeyId, String secretAccessKey, String enviroment,
            String application, String appversion, String description ) throws Exception {
        /*if (args.length < 3) {
        System.err.println("Usage: UrlInfo ACCESS_KEY_ID " +
        "SECRET_ACCESS_KEY site");
        System.exit(-1);
       ...
       // String war = "cloud4soa";
        ...
        BeansUpdateEnvironment updater = new BeansUpdateEnvironment(accessKeyId, secretAccessKey, enviroment,application, appversion, description);
