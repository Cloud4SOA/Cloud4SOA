 ...
 */
public class BeansTerminateEnvironment {

    private static final String ACTION_NAME = "TerminateEnvironment";
    ...
    public BeansTerminateEnvironment() {

    }


    public BeansTerminateEnvironment(String accessKeyId, String secretAccessKey, String environment) {
    ...
    protected String buildQuery()
     ...
     //   queryParams.put("SourceBundle.S3Key", "201119338g-SimpleWar.war");
        queryParams.put("TerminateResources", "true");
...
//    public static void main(String[] args) throws Exception {
    ...
    */
    ...
    public void terminateenvironment(String accessKeyId, String secretAccessKey, String enviroment) throws Exception {
        /*if (args.length < 3) {
        System.err.println("Usage: UrlInfo ACCESS_KEY_ID " +
        "SECRET_ACCESS_KEY site");
        System.exit(-1);
       ...
       // String war = "cloud4soa";
        ...
        BeansTerminateEnvironment updater = new BeansTerminateEnvironment(accessKeyId, secretAccessKey, enviroment);
