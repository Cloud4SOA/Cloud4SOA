 ...
 */
public class BeansCreateApplicationVersion {

    private static final String ACTION_NAME = "CreateApplicationVersion";
  //  private static final String ACTION_NAME = "CheckDNSAvailability";
    private String APPLICATION_NAME = "SimpleWar";
    private String APP_VERSION_LABEL = "1.34";
    ...
    public BeansCreateApplicationVersion(String accessKeyId, String secretAccessKey, String war, String bucket,
    ...
    public BeansCreateApplicationVersion( ) {
...
/*
        BeansCreateApplicationVersion updater = new BeansCreateApplicationVersion(accessKey, secretKey, war);
    ...
    */
    ...
    public String creatappversion(String accessKeyId, String secretAccessKey, String war, String bucket,
            String application, String appversion ) throws IOException,SignatureException {
        String ret="";
        /*if (args.length < 3) {
        System.err.println("Usage: UrlInfo ACCESS_KEY_ID " +
        "SECRET_ACCESS_KEY site");
        ...
        BeansCreateApplicationVersion updater = new BeansCreateApplicationVersion( accessKeyId, secretAccessKey,war,
                    bucket,application,appversion);
