 ...
 */
public class BeansDescribeApplicationVersions {

     private static final String ACTION_NAME = "DescribeApplicationVersions";
  //  private static final String ACTION_NAME = "CheckDNSAvailability";
   ...
   public BeansDescribeApplicationVersions(){

    }
    public BeansDescribeApplicationVersions(String accessKeyId, String secretAccessKey,String application) {
...
//    public static void main(String[] args) throws Exception {
    ...
    */
    ...
    public void decribeApplicationVersions(String accessKeyId, String secretAccessKey, String application ) throws InvalidParameterValueException {
        ...
        try {
            ...
            // String war = "cloud4soa";
            BeansDescribeApplicationVersions updater = new BeansDescribeApplicationVersions(accessKeyId, secretAccessKey, application);
            String query = updater.buildQuery();
            String toSign = "GET\n" + service_host + "\n/\n" + query;
            System.out.println("String to sign:\n" + toSign + "\n");
            ...
            try {
                ...
                Logger.getLogger(BeansDescribeApplicationVersions.class.getName()).log(Level.SEVERE, null, ex);
            }
