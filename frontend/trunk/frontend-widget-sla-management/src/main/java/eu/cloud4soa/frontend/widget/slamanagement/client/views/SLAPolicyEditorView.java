 ...
 */
public interface SLAPolicyEditorView extends IsWidget {
	...
	public interface Presenter extends Cloud4SoaPresenter {
		void addSLAPolicy();
		void onSLAPolicyDeleteButtonClick(SLAPolicyModel slaPolicyModel);
		void onSLAPolicyCancel();
		void onSLAPolicyDone();
		void onSLAPolicyFieldChanged();
	}
