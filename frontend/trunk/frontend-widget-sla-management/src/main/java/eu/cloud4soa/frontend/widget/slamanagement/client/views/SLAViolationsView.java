...
public interface SLAViolationsView extends IsWidget{
	void setPresenter(Presenter presenter);
	
	//View specific methods to transfer data from the activity to the view
	void setSLAViolationsData(SLAStore store);
	void filterSLAViolationsByApplicationId(String applicationId);
