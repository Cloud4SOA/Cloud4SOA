 ...
 */
public class FacetedSearchWidget implements EntryPoint {
	...
	public void onModuleLoad() {
		...
		RootPanel panel = RootPanel.get("facetedsearch-main");
		...
		if (panel != null){ 
	        ...
	        FacetedSearchActivity activity = new FacetedSearchActivity(clientFactory);
	        
	        SimplePanel appWidget = new SimplePanel();
	        RootPanel.get("facetedsearch-main").add(appWidget);
