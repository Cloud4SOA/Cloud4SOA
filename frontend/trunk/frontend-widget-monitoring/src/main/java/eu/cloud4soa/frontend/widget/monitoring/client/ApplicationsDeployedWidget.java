...
package eu.cloud4soa.frontend.widget.monitoring.client;
 ...
 */
public class ApplicationsDeployedWidget implements EntryPoint {
	...
	public void onModuleLoad() {
		...
		RootPanel panel = RootPanel.get("appdeployed-main");
		...
		if (panel != null){ 
	        ...
	        ApplicationsDeployedActivity activity = new ApplicationsDeployedActivity(clientFactory);
	        
	        SimplePanel appWidget = new SimplePanel();
	        RootPanel.get("appdeployed-main").add(appWidget);
