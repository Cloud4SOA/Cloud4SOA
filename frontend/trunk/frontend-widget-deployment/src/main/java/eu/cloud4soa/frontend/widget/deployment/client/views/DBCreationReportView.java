 ...
 */
public interface DBCreationReportView extends IsWidget {

	void setPresenter(Presenter presenter);

	void bindDBCreationReportForm(SoftwareComponentModel softwareComponentModel);

	public interface Presenter extends Cloud4SoaPresenter {
		void onDBCreationReportAcceptedClick();
	}
