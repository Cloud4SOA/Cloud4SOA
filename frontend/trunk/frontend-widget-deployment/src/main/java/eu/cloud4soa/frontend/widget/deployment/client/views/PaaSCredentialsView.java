 ...
 */
public interface PaaSCredentialsView extends IsWidget {

	void setPresenter(Presenter presenter);

	void bindCredentialsForm(final UserCredentialsModel credentialsModel);

	void bindPaaSOfferingForm(final PaaSOfferingModel paasOfferingModel);
