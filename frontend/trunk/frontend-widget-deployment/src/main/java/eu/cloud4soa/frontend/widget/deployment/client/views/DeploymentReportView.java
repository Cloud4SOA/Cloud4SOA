 ...
 */
public interface DeploymentReportView extends IsWidget {

	void setPresenter(Presenter presenter);

	void bindDeploymentReportForm(ApplicationModel applicationModel);

	public interface Presenter extends Cloud4SoaPresenter {
		void onDeploymentReportAcceptedClick();
	}
