...
/**
 * View providing instruction to deploy the application by mean of the Cloud4SOA Command Line Interface.
 *
 * @author Stefano Travelli (Cyntelix)
 */
public class CliDeploymentView extends Composite {

    private static CliDeploymentViewUiBinder binder = GWT.create(CliDeploymentViewUiBinder.class);
    ...
    interface CliDeploymentViewUiBinder extends UiBinder<ScrollPanel, CliDeploymentView> {
    }
}