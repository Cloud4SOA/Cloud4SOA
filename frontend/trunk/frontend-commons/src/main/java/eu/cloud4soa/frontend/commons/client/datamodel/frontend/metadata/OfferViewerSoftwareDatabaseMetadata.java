 ...
 */
public class OfferViewerSoftwareDatabaseMetadata extends EntityMetadata
		implements IsSerializable {

	public OfferViewerSoftwareDatabaseMetadata() {

		field(FieldMetadata.create(SOFTWARE_CATEGORY).label("Category")
				.editType(COMBOBOX).tooltip("Database component category")
				.relatedEntityType(COMBO_DATABASE_CATEGORY).readonly(true));
