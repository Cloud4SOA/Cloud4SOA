 ...
 */
public class SLATemplateServiceModel extends DynamicFormModel implements
		IsSerializable {
	...
	public SLATemplateServiceModel() {
	}

	public SLATemplateServiceModel(String key, String value) {
		super(key, value, MetadataMapper.FORM_SLA_TEMPLATE_SERVICE);
	}
