...
/**
 * Storage category dao implementation
 *
 * @author Stefano Travelli (Cyntelix)
 */
@Transactional
@Repository
public class StorageCategoryRepository extends BaseRepository<HardwareCategoryModel, HardwareCategory> implements StorageCategoryDao {

    public StorageCategoryRepository() {
