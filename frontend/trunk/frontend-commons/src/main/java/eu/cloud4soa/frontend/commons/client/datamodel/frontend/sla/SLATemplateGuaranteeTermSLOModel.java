 ...
 */
public class SLATemplateGuaranteeTermSLOModel extends DynamicFormModel implements IsSerializable {
    ...
    public SLATemplateGuaranteeTermSLOModel() {
    }

    public SLATemplateGuaranteeTermSLOModel(String key, String value) {
        super(key, value, MetadataMapper.FORM_SLA_TEMPLATE_GT_SLO);
    }
