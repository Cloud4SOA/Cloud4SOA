...
/**
 * List store for sql database category
 *
 * @author Stefano Travelli (Cyntelix)
 */
public class SqlDatabaseCategoryListStore extends ListStore<SoftwareCategoryModel> {
    public SqlDatabaseCategoryListStore() {
        super(new BaseListLoader<ListLoadResult<SoftwareCategoryModel>>(new RpcProxy<ListLoadResult<SoftwareCategoryModel>>() {
            ...
            protected void load(Object o, AsyncCallback<ListLoadResult<SoftwareCategoryModel>> callBack) {
                modelManagerService.retrieveSqlDatabaseCategories(callBack);
            }
        }));
    }
}
