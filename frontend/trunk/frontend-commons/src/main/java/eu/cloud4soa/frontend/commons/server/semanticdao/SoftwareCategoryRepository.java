...
/**
 * Software category dao implementation.
 *
 * @author Stefano Travelli (Cyntelix)
 */
@Transactional
@Repository
public class SoftwareCategoryRepository extends BaseRepository<SoftwareCategoryModel, SoftwareCategory> implements SoftwareCategoryDao {

    public SoftwareCategoryRepository() {
