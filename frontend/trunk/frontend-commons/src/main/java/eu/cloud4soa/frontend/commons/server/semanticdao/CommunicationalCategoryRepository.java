...
/**
 * Communicational category dao implementation
 *
 * @author Stefano Travelli (Cyntelix)
 */
@Transactional
@Repository
public class CommunicationalCategoryRepository extends BaseRepository<HardwareCategoryModel, HardwareCategory> implements CommunicationalCategoryDao {

    public CommunicationalCategoryRepository() {
        super(HardwareCategoryModel.class,
                CommunicationalCategory.class,
