...
/**
 * Hardware category dao implementation
 *
 * @author Stefano Travelli (Cyntelix)
 */
@Transactional
@Repository
public class HardwareCategoryRepository extends BaseRepository<HardwareCategoryModel, HardwareCategory> implements HardwareCategoryDao {

    public HardwareCategoryRepository() {
