 ...
 */
public class DeploymentReportApplicationMetadata extends EntityMetadata
		implements IsSerializable {
	public DeploymentReportApplicationMetadata() {

		field(FieldMetadata.create(ApplicationModel.TITLE).label("Name")
				.editType(TEXT).tooltip("Application name").readonly(true));
		field(FieldMetadata.create(ApplicationModel.DEPLOYMENT_URL)
				.label("Deployment URL").editType(TEXT)
				.tooltip("Deployment URL").readonly(true));
	}
}
