...
import eu.cloud4soa.frontend.commons.server.services.soa.mapping.ProviderUserMapper;
import org.springframework.stereotype.Repository;
import org.springframework.transaction.annotation.Transactional;

/**
 * Provider user repository implementation.
 *
 * @author Stefano Travelli (Cyntelix)
 */
@Transactional
@Repository
public class ProviderUserRepository extends BaseRepository<UserModel, PaaSUser> implements ProviderUserDao {


    public ProviderUserRepository() {
        super(UserModel.class,
                PaaSUser.class,
                new ProviderUserMapper());
    }
