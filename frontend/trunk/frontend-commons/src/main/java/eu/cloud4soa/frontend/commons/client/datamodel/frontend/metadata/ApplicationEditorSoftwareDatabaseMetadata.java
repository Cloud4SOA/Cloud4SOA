...
/**
 * DB Storage component metadata
 *
 * @author Stefano Travelli (Cyntelix)
 */
public class ApplicationEditorSoftwareDatabaseMetadata extends EntityMetadata implements IsSerializable {

    public ApplicationEditorSoftwareDatabaseMetadata() {
        ...
        field(FieldMetadata.create(REQUIRED)
                .label(Strings.EMPTY)
                .boxLabel("Database component is required.")
                .editType(CHECKBOX)
                .tooltip("Check if this database component is required.")
        );
