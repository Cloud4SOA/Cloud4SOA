...
/**
 * List store for communication category
 *
 * @author Stefano Travelli (Cyntelix)
 */
public class ComputationCategoryListStore extends ListStore<HardwareCategoryModel> {
    public ComputationCategoryListStore() {
        super(new BaseListLoader<ListLoadResult<HardwareCategoryModel>>(new RpcProxy<ListLoadResult<HardwareCategoryModel>>() {
            ...
            protected void load(Object o, AsyncCallback<ListLoadResult<HardwareCategoryModel>> callBack) {
                modelManagerService.retrieveComputationCategories(callBack);
            }
        }));
    }
}
