 ...
 */
public class SLATemplateGuaranteeTermBLOModel extends DynamicFormModel implements IsSerializable {
    ...
    public SLATemplateGuaranteeTermBLOModel() {
    }

    public SLATemplateGuaranteeTermBLOModel(String key, String value) {
        super(key, value, MetadataMapper.FORM_SLA_TEMPLATE_GT_BLO);
    }
