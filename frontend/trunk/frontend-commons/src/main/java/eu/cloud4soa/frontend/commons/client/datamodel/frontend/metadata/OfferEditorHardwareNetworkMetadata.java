 ...
 */
public class OfferEditorHardwareNetworkMetadata extends EntityMetadata implements IsSerializable {

    public OfferEditorHardwareNetworkMetadata() {
        ...
        // latency
        field(FieldMetadata.create(LATENCY)
                .label("Latency")
                .editType(EDIT_MEASURE_RANGE)
                .allowDecimals(false)
                .allowNegative(false)
                .tooltip("Type the offered latency")
        );
