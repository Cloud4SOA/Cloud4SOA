...
/**
 * This event notifies that a paas offer has been selected in the paas offer search results list
 *
 * @author Yosu Gorroñogoitia
 * @since 13/10/11 21.54
 */
public class PaaSOfferingSelectedEvent extends GwtEvent<PaaSOfferingSelectedEvent.Handler> {
    public interface Handler extends EventHandler {
        void onPaaSOfferingSelected(PaaSOfferingSelectedEvent event);
    }
    ...
    public PaaSOfferingSelectedEvent(PaaSOfferingModel paaSOffering) {
    ...
    protected void dispatch(Handler handler) {
        handler.onPaaSOfferingSelected(this);
    }
