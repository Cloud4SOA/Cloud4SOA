...
/**
 * Credentials form for Heroku
 * 
 * @author Stefano Travelli (Cyntelix)
 */
public class DeploymentFormHerokuCredentialsMetadata extends EntityMetadata implements
		IsSerializable {
	public DeploymentFormHerokuCredentialsMetadata() {

		field(FieldMetadata.create(UserCredentialsModel.PUBLIC_KEY)
				.label("API key").editType(TEXT)
				.tooltip("The Heroku API key")
				.allowBlank(false));
	}
}
