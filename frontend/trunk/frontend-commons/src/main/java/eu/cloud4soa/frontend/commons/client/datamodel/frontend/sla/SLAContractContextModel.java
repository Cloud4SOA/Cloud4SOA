 ...
 */
public class SLAContractContextModel extends DynamicFormModel implements
		IsSerializable {
	...
	public SLAContractContextModel() {
	}

	public SLAContractContextModel(String key, String value) {
		super(key, value, MetadataMapper.FORM_SLA_CONTRACT_CONTEXT);
	}
