...
/**
 * The view contract for the application profile read only view.
 *
 * @author Stefano Travelli (Cyntelix)
 */
public interface ApplicationProfileView extends IsWidget {
    ...
    public void bindApplication(ApplicationModel applicationModel);
