...
/**
 * View contract for the application tools panel.
 *
 * @author Stefano Travelli (Cyntelix)
 */
public interface ApplicationToolsView extends IsWidget {

    void setPresenter(Presenter presenter);

    public interface Presenter extends Cloud4SoaPresenter {
        public void onApplicationComponentSelected(DisplayableKeyValueModelData softwareComponent);
    }
}