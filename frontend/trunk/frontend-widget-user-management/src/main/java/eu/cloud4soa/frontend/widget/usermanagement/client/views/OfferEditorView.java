 ...
 */
public interface OfferEditorView extends IsWidget {
    ...
    public interface Presenter extends Cloud4SoaPresenter {
        ...
        void onHardwareComponentDeleteButtonClick(HardwareComponentModel hardwareComponentModel);

        void onSoftwareComponentDeleteButtonClick(SoftwareComponentModel softwareComponentModel);

        void addHardwareNetworkComponent();

        void addHardwareGenericComponent();
        ...
        void addNoSqlDatabaseComponent();
