...
/**
 * The application profile list view contract.
 *
 * @author Stefano Travelli (Cyntelix)
 */
public interface ApplicationProfileListView extends IsWidget {
    ...
    public interface Presenter extends Cloud4SoaPresenter {
        ...
        void onNewButtonClick(String applicationTemplate);
    }
