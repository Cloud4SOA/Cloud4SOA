...
/**
 * The view contract of the register page.
 * 
...
public interface RegistrationView extends IsWidget {
    ...
    enum UserAccountProperty {
		USERNAME, PASSWORD, FIRSTNAME, SURNAME, GEEKCODE, EMAIL
	}

	HasValue<String> getUserAccountProperty(UserAccountProperty property);

	HasValue<Date> getUserAccountBirthday();
