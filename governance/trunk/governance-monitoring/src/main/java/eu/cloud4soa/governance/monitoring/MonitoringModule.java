...
logger.info("adapterUrl in try "+applicationInstance.getAdapterUrl());
//        try {
//            //applicationInstance  = applicationProfilesRepository.getApplicationInstance(applicationUriId);
//            url = applicationInstance.getAdapterUrl();
//		logger.info("adapterUrl in try "+url);
//        } catch (RepositoryException ex) {
//            logger.error("Unable to start monitoring for application " + applicationInstance.getUriId() + ". " +
//                    "Cannot retrieve application instance.", ex);
//            return;
//        }
	...
	public List<IMonitoringStatistic> getMonitoringStatisticsWhithinRangeLimited(String applicationUriId, Date start, Date end, int maxResults) {
        ...
        public List<IMonitoringMetric> getMonitoringMetricsWhithinRangeLimited(String applicationUriId, String metricKey, Date start, Date end, int maxResults){
		MonitoringJob monitoringJob = (MonitoringJob) getMonitoringJob(applicationUriId);
